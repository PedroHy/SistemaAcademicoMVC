...
public class PanelGerenciarNotas extends JPanel {
	...
	public PanelGerenciarNotas() {
		...
		textField_2.setBounds(200, 217, 722, 33);
		add(textField_2);
		...
		textField_6.setBounds(760, 339, 162, 33);
		add(textField_6);
		...
		comboBox_1.setBounds(200, 340, 162, 33);
		add(comboBox_1);
